...
func seedBallots(db *sql.DB) error {
	...
	ballots := []struct {
		...
		// ===============================================================
		// 09 - TEXAS SUPER STATE (12 Mini-States / CLR Districts)
		// ===============================================================
		// CLR-D-1, South-East Dallas
		{
			creatorID:   userID1,
			title:       "South-East Dallas Community Development",
			description: "Vote on community development priorities for the South-East Dallas CLR District.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-east-dallas",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-East Dallas Public Safety Initiative",
			description: "Should South-East Dallas expand community-based public safety programs?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-east-dallas",
			isActive:    true,
		},
		// CLR-D-2, North-East Dallas
		{
			creatorID:   userID2,
			title:       "North-East Dallas Education Investment",
			description: "Vote on expanding education infrastructure in the North-East Dallas CLR District.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "north-east-dallas",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "North-East Dallas Transportation Upgrade",
			description: "Should North-East Dallas invest in public transportation improvements?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "north-east-dallas",
			isActive:    true,
		},
		// CLR-D-3, North-West Texas
		{
			creatorID:   userID1,
			title:       "North-West Texas Agricultural Support",
			description: "Vote on enhanced support for agricultural communities in North-West Texas.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "north-west-texas",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "North-West Texas Wind Energy Expansion",
			description: "Should North-West Texas expand wind energy infrastructure?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "north-west-texas",
			isActive:    true,
		...
		{
			creatorID:   userID2,
			title:       "West Texas Energy Grid Independence",
			description: "Vote on measures to strengthen West Texas energy grid resilience.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "west-texas",
			isActive:    true,
		...
		{
			creatorID:   userID1,
			title:       "West Texas Water Resource Management",
			description: "Should West Texas implement a comprehensive water resource management plan?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "west-texas",
			isActive:    true,
		},
		// CLR-D-5, South-West Texas
		{
			creatorID:   userID1,
			title:       "South-West Texas Border Community Support",
			description: "Vote on increasing funding for border community infrastructure in South-West Texas.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-west-texas",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-West Texas Cultural Preservation",
			description: "Should South-West Texas increase funding for cultural preservation programs?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-west-texas",
			isActive:    true,
		},
		// CLR-D-6, South Dallas
		{
			creatorID:   userID2,
			title:       "South Dallas Economic Development",
			description: "Vote on economic development initiatives for the South Dallas CLR District.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-dallas",
			isActive:    true,
		...
		{
			creatorID:   userID1,
			title:       "South Dallas Infrastructure Improvement",
			description: "Should South Dallas prioritize infrastructure improvement projects?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-dallas",
			isActive:    true,
		},
		// CLR-D-7, South-Central Texas
		{
			creatorID:   userID1,
			title:       "South-Central Texas Healthcare Access",
			description: "Vote on expanding healthcare access in the South-Central Texas CLR District.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-central-texas",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-Central Texas Tech Industry Growth",
			description: "Should South-Central Texas expand incentives for technology companies?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-central-texas",
			isActive:    true,
		},
		// CLR-D-8, South-Coast Texas
		{
			creatorID:   userID2,
			title:       "South-Coast Texas Hurricane Resilience",
			description: "Vote on creating a hurricane resilience infrastructure fund for South-Coast Texas.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-coast-texas",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "South-Coast Texas Port Expansion",
			description: "Should South-Coast Texas expand port facilities and shipping infrastructure?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-coast-texas",
			isActive:    true,
		},
		// CLR-D-9, South-West Houston
		{
			creatorID:   userID1,
			title:       "South-West Houston Flood Prevention",
			description: "Vote on comprehensive flood prevention measures for South-West Houston.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-west-houston",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-West Houston Transit Development",
			description: "Should South-West Houston invest in expanded mass transit options?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-west-houston",
			isActive:    true,
		},
		// CLR-D-10, Central-East Texas
		{
			creatorID:   userID2,
			title:       "Central-East Texas Rural Broadband",
			description: "Vote on rural broadband expansion initiatives for Central-East Texas.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "central-east-texas",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "Central-East Texas Forestry Conservation",
			description: "Should Central-East Texas expand forestry conservation programs?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "central-east-texas",
			isActive:    true,
		},
		// CLR-D-11, North Houston
		{
			creatorID:   userID1,
			title:       "North Houston Energy Innovation",
			description: "Vote on energy sector innovation funding for the North Houston CLR District.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "north-houston",
			isActive:    true,
		...
		{
			creatorID:   userID2,
			title:       "North Houston Education Reform",
			description: "Should North Houston implement comprehensive education reform?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "north-houston",
			isActive:    true,
		},
		// CLR-D-12, South-East Texas
		{
			creatorID:   userID1,
			title:       "South-East Texas Petrochemical Safety",
			description: "Vote on enhanced safety standards for petrochemical facilities in South-East Texas.",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-east-texas",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-East Texas Coastal Protection",
			description: "Should South-East Texas strengthen coastal protection measures?",
			category:    "local-civil",
			superstate:  "texas",
			state:       "south-east-texas",
			isActive:    true,
		...
		// ===============================================================
		// 12 - CALIFORNIA SUPER STATE (12 Mini-States / CLR Districts)
		// ===============================================================
		// CLR-D-1, North California
		{
			creatorID:   userID1,
			title:       "North California Water Conservation Initiative",
			description: "Vote on water conservation and infrastructure measures for North California.",
			category:    "local-civil",
		...
		{
			creatorID:   userID2,
			title:       "North California Wildfire Prevention",
			description: "Should North California increase funding for wildfire prevention and response?",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-california",
			isActive:    true,
		},
		// CLR-D-2, East Bay-Area
		{
			creatorID:   userID2,
			title:       "East Bay-Area Transit Expansion",
			description: "Vote on expanding public transit infrastructure in the East Bay-Area.",
			category:    "local-civil",
			superstate:  "california",
			state:       "east-bay-area",
			isActive:    true,
		...
		{
			creatorID:   userID1,
			title:       "East Bay-Area Affordable Housing",
			description: "Should the East Bay-Area expand affordable housing programs?",
			category:    "local-civil",
			superstate:  "california",
			state:       "east-bay-area",
			isActive:    true,
		},
		// CLR-D-3, South-East Bay-Area
		{
			creatorID:   userID1,
			title:       "South-East Bay-Area Tech Innovation Fund",
			description: "Vote on creating a technology innovation fund for the South-East Bay-Area.",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-east-bay-area",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-East Bay-Area Environmental Protection",
			description: "Should the South-East Bay-Area strengthen environmental protection measures?",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-east-bay-area",
			isActive:    true,
		},
		// CLR-D-4, South San-Francisco
		{
			creatorID:   userID2,
			title:       "South San-Francisco Biotech Investment",
			description: "Vote on expanding biotech industry support in South San-Francisco.",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-san-francisco",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "South San-Francisco Infrastructure Modernization",
			description: "Should South San-Francisco prioritize infrastructure modernization?",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-san-francisco",
			isActive:    true,
		},
		// CLR-D-5, Central California
		{
			creatorID:   userID1,
			title:       "Central California Agricultural Innovation",
			description: "Vote on agricultural technology innovation funding for Central California.",
			category:    "local-civil",
			superstate:  "california",
		...
		{
			creatorID:   userID2,
			title:       "Central California Water Resource Management",
			description: "Should Central California implement a comprehensive water resource management plan?",
			category:    "local-civil",
			superstate:  "california",
			state:       "central-california",
			isActive:    true,
		},
		// CLR-D-6, North-Coast Los-Angeles
		{
			creatorID:   userID2,
			title:       "North-Coast Los-Angeles Coastal Protection",
			description: "Vote on coastal protection measures for the North-Coast Los-Angeles CLR District.",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-coast-los-angeles",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "North-Coast Los-Angeles Entertainment Industry Support",
			description: "Should North-Coast Los-Angeles expand support for the entertainment industry?",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-coast-los-angeles",
			isActive:    true,
		},
		// CLR-D-7, North Los-Angeles
		{
			creatorID:   userID1,
			title:       "North Los-Angeles Transportation Reform",
			description: "Vote on transportation reform initiatives for the North Los-Angeles CLR District.",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-los-angeles",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "North Los-Angeles Air Quality Improvement",
			description: "Should North Los-Angeles invest in air quality improvement programs?",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-los-angeles",
			isActive:    true,
		},
		// CLR-D-8, North-East Los-Angeles
		{
			creatorID:   userID2,
			title:       "North-East Los-Angeles Community Development",
			description: "Vote on community development priorities for the North-East Los-Angeles CLR District.",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-east-los-angeles",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "North-East Los-Angeles Education Investment",
			description: "Should North-East Los-Angeles increase education funding?",
			category:    "local-civil",
			superstate:  "california",
			state:       "north-east-los-angeles",
			isActive:    true,
		},
		// CLR-D-9, East Los-Angeles
		{
			creatorID:   userID1,
			title:       "East Los-Angeles Small Business Growth",
			description: "Vote on small business development incentives for East Los-Angeles.",
			category:    "local-civil",
			superstate:  "california",
			state:       "east-los-angeles",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "East Los-Angeles Public Safety Reform",
			description: "Should East Los-Angeles implement community-based public safety programs?",
			category:    "local-civil",
			superstate:  "california",
			state:       "east-los-angeles",
			isActive:    true,
		},
		// CLR-D-10, South-Coast Los-Angeles
		{
			creatorID:   userID2,
			title:       "South-Coast Los-Angeles Port Modernization",
			description: "Vote on port modernization and expansion in South-Coast Los-Angeles.",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-coast-los-angeles",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "South-Coast Los-Angeles Clean Energy Initiative",
			description: "Should South-Coast Los-Angeles accelerate its clean energy transition?",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-coast-los-angeles",
			isActive:    true,
		},
		// CLR-D-11, South-East California
		{
			creatorID:   userID1,
			title:       "South-East California Renewable Energy",
			description: "Vote on expanding renewable energy infrastructure in South-East California.",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-east-california",
			isActive:    true,
		},
		{
			creatorID:   userID2,
			title:       "South-East California Desert Conservation",
			description: "Should South-East California strengthen desert ecosystem conservation?",
			category:    "local-civil",
			superstate:  "california",
			state:       "south-east-california",
			isActive:    true,
		},
		// CLR-D-12, San-Diego Coast
		{
			creatorID:   userID2,
			title:       "San-Diego Coast Military Community Support",
			description: "Vote on support measures for military communities in the San-Diego Coast CLR District.",
			category:    "local-civil",
			superstate:  "california",
			state:       "san-diego-coast",
			isActive:    true,
		},
		{
			creatorID:   userID1,
			title:       "San-Diego Coast Border Infrastructure",
			description: "Should San-Diego Coast invest in border community infrastructure?",
			category:    "local-civil",
			superstate:  "california",
			state:       "san-diego-coast",
			isActive:    true,
